...
public class getObjectDescription extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        ...
        tm_concepts.put("ArCond","Perciana: Cor Bege");
		tm_concepts.put("apaceWindow1","Perciana: Cor Bege");
		...
		tm_concepts.put("Mochila1","Cadeira: Cor preta");
		tm_concepts.put("Mochila2","Cadeira: Cor preta");
		tm_concepts.put("Mochila3","Cadeira: Cor preta");
