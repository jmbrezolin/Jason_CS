...
public class getObjectCenterX extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
    	...
    	try {	
		    ...
		    String obj_centerx = parts[2];
			double value = Double.parseDouble(obj_centerx);
			NumberTerm result = new NumberTermImpl(value);
		    //StringTerm result2 =  new StringTermImpl(obj_centerx);
